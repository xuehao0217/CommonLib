...
@Stable
@Composable
fun AppBaseTheme(themeType: AppThemeType = AppThemeType.Light, content: @Composable () -> Unit) {
    val colors =
        if (AppThemeType.isDark(themeType = themeType)) darkThemeColors else lightThemeColors
